...
var dpwMenu = function () {
    var items = [
        {
            title: 'Develop Apps',
            link: 'https://dev.weebly.com/pf_getStarted.html',
            external: true
            /*
            items: [
                {
                    title: 'Sub Menu Item',
                    link: 'https://dev.weebly.com/sub-menu-path'
                }
            ]
            */
        },
        {
            ...
            link: 'https://dev.weebly.com/pf_themes_start.html',
            external: true
        },
        {
            title: 'APIs',
            link: 'https://dev.weebly.com/pf_apis_about.html',
            external: true
        },
        {
            title: 'Tutorials',
            link: 'https://dev.weebly.com/pf_element_main.html',
            external: true
        },
        {
            title: 'Dev Admin Portal',
            link: 'http://www.weebly.com/developer-admin',
            external: true
        }
    ];
